...
<body class="bg-gradient-to-br from-[var(--primary-green)] to-[var(--secondary-green)] text-white min-h-screen flex items-center justify-center px-4">
  ...
  <div class="bg-white text-gray-800 rounded-2xl shadow-2xl px-8 py-10 max-w-md w-full border-4 border-transparent hover:border-[var(--primary-green)] transition duration-300">
    <h2 class="text-3xl font-extrabold text-center text-[var(--primary-green)] mb-2">Register</h2>
    <p class="text-center text-sm text-gray-500 mb-6">Daftarkan dirimu segera dan nikmati Handai Coffee!</p>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
      ...
      <div>
        ...
        <input type="text" id="name" name="name" required placeholder="Contoh: handaifan123"
    ...
    <div class="text-center mt-6">
      <p class="text-sm">Sudah punya akun? 
        <a href="{{ route('login') }}" class="text-[var(--primary-green)] font-medium hover:underline">Login di sini</a>
      </p>
    </div>
